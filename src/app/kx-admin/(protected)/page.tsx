                    ...
                    {isEditing ? (
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          ...
                          {/*
                            FIX (2026-07-06): This form previously had an inline
                            onSubmit={(e) => { if (!confirm(...)) e.preventDefault() }}
                            attached directly to a <form> inside a Server Component.
                            Next.js 15 cannot attach event handlers to elements
                            rendered from a Server Component — this crashed the
                            entire /kx-admin/channels page on every load.

                            Fix: confirm() now lives inside ConfirmDeleteButton,
                            a "use client" component (same pattern already used
                            on the moderation and placements pages). The
                            Server Component only renders <form action={...}>,
                            which Next.js 15 server actions support natively.
                          */}
                          <form action={deleteChannelAction}>
                            <input type="hidden" name="channelId" value={channel.id} />
                            <ConfirmDeleteButton
                              confirmMessage={`Are you sure you want to permanently delete "${channel.title}"? This action cannot be undone.`}
                            />
                          </form>
                        </div>
                      </div>
