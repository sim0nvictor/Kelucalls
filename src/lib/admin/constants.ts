export const ADMIN_BASE_PATH = "/kx-admin";
export const ADMIN_SIGN_IN_PATH = `${ADMIN_BASE_PATH}/sign-in`;


export const ADMIN_ACCESS_COOKIE = "kelucalls_admin_access_token";
